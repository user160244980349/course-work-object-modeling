            ...
            <div class="col-md-6 offset-3">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col d-flex justify-content-end">
                                <div class="btn-group-sm">
                                    <a class="btn btn-primary"
                                       href="{{ route('web.documents.parameter.read', ['prod_id' => $product->id, $document->id, 'id' => $parameter->id]) }}">Отменить
                                        изменения</a>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('documents.parameter.update', ['prod_id' => $product->id, 'doc_id' => $document->id, 'id' => $parameter->id]) }}"
                              method="post">
                            @csrf
                            @method('put')
