            ...
            <div class="col-md-6 offset-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form role="form" method="post" action="{{ route('web.products.positions.create', ['prod_id' => $product->id]) }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <input id="count" type="text" class="form-control form-control-sm" name="count" required
                                                           autofocus/>
                                                </div>
                                            </div>
